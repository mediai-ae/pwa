<template>
  <div
      class="relative rounded-2xl border border-gray-200 dark:border-gray-700 shadow p-4 space-y-4 transition hover:shadow-md bg-white dark:bg-gray-900"
  >
    <!-- Top-right action buttons -->
    <div class="absolute top-2 right-2 flex items-center gap-2">
      <button
          v-if="media.url && media.media_type !== 'image'"
    ...
    <!-- Action Buttons -->
    <div v-if="media.media_type === 'video'" class="flex flex-wrap items-center gap-2 pt-2">
      <button
